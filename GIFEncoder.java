 ...
 */
 //modified by Karen Bailey 9/1/03 to provide GUI integrated error messages
 ...
 * */
	...
	for (int x = 0; x < width_; ++x) {
		...
		if (search > 255)
		{
		    JOptionPane.showMessageDialog(null, "The image could not be saved as there were too many colors created by the stegoing process.\nPlease choose an image with fewer colors in its palette and try again.", "Message", 
